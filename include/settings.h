#ifndef __INCLUDE_SETUP_H_
#define __INCLUDE_SETUP_H_
...
#define DEMO_TIME     300           // Время отображение эффекта в демо режиме в секундах
...
#define PALETTE_TIME  180          // Через сколько секунд менять палитру если 0 - не меняем
